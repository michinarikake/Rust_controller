...
/// **演算子のオーバーロード**
impl Add for Force6dEci {
    type Output = Force6dEci;
    fn add(self, rhs: Force6dEci) -> Force6dEci {
        self.add_vec(&rhs)
    }
}
...
impl Sub for Force6dEci {
    type Output = Force6dEci;
    fn sub(self, rhs: Force6dEci) -> Force6dEci {
        self.sub_vec(&rhs)
    }
}
...
impl Mul<f64> for Force6dEci {
    type Output = Force6dEci;
    fn mul(self, scalar: f64) -> Force6dEci {
...
impl Div<f64> for Force6dEci {
    type Output = Force6dEci;
    fn div(self, scalar: f64) -> Force6dEci {
...
impl Mul<Force6dEci> for Array2<f64> {
    type Output = Force6dEci;
    fn mul(self, rhs: Force6dEci) -> Force6dEci {
        let result = self.dot(rhs.get_vector());
        Force6dEci::form_from_array(result)
    }
}
